...
# One-liner: curl -fsSL https://raw.githubusercontent.com/juansemastrangelo/tensorx/main/bootstrap.sh | bash

echo "ðŸï¸  Islands Dark Theme Bootstrap Installer"
echo "=========================================="
echo ""

REPO_URL="https://github.com/juansemastrangelo/tensorx.git"
INSTALL_DIR="$HOME/.tensorx-temp"
...
if [[ "$OS" == "macOS" ]] || [[ "$OS" == "Linux" ]]; then
    ...
    echo "âš ï¸  Automatic installation not supported for this OS"
...
echo ""
echo -e "ðŸŽ‰ Done! Enjoy your Islands Dark theme!"
